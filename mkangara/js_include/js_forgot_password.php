            ...
            <div class="container">
                ...
                <div class="row box-5">
                    <div>
						...
						<div>
                        <form class='mkangara-form' action="index.php?action=forgot_password" method="post">
						<center><h2><b><u>Fill in the form below to get assistance on recovering your pasword</u></b></h2></center><br>
					...
					<input type="email" name="email" id="email" autocomplete="off" required autofocus />
								...
								<center><input type="submit" class="submit_this" name="ForgotPassword" value="Forgot Password" >
					  </center><br></form>
						</div>
                    </div>    
                    </div>
