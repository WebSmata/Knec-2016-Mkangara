	...
	<div class="container">		
		<div class="row box-5">
			<div>
				...
				<div class="page_wrap">
				<h1>Add an Product</h1><br>
				<div>
				<form class='mkangara-form' method="post" action="index.php?action=product_new" 
			enctype="multipart/form-data">
                ...
                <tr>
					...
					<td><input type="text" autocomplete="off" name="price" required ></td>
						...
						<center><input type="submit" class="submit_this" name="AddProduct" value="Save Product">
			  </center><br></form>
				</div>
			</div>    
			</div>
